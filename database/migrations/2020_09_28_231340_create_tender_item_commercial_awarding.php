...
class CreateTenderItemCommercialAwarding extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tender_item_commercial_awarding', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tender_item_commercial_awarding');
    }
}
