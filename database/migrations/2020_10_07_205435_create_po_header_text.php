...
class CreatePoHeaderText extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('po_header_text', function (Blueprint $table) {
            $table->id();
        ...
        DB::statement('insert into po_header_text
    ...
    {
        Schema::dropIfExists('po_header_text');
    }
}
