...
class CreateTenderItemTechnicalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tender_item_technical', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tender_item_technical');
    }
}
