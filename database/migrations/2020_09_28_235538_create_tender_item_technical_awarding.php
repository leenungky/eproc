...
class CreateTenderItemTechnicalAwarding extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tender_item_technical_awarding', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tender_item_technical_awarding');
    }
}
