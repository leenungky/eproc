...
class CreateTenderItemTextTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tender_item_text', function (Blueprint $table) {
            $table->id();
        ...
        DB::statement('insert into tender_item_text
    ...
    {
        Schema::dropIfExists('tender_item_text');
    }
}
