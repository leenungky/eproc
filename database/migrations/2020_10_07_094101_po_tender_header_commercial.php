...
class PoTenderHeaderCommercial extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('po_tender_header_commercial', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('po_tender_header_commercial');
    }
}
