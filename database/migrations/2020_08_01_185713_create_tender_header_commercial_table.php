...
class CreateTenderHeaderCommercialTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tender_header_commercial', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tender_header_commercial');
    }
}
