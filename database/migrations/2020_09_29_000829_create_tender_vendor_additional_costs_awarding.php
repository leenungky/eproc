...
class CreateTenderVendorAdditionalCostsAwarding extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tender_vendor_additional_costs_awarding', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tender_vendor_additional_costs_awarding');
    }
}
