...
class PoTenderItems extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        ...
        Schema::create('po_items', function (Blueprint $table) {
            ...
            $table->decimal('price_unit', 19,3)->nullable(true);
    ...
    {
        Schema::dropIfExists('pl_tender_items');
        DB::statement('DROP SEQUENCE IF EXISTS po_tender_items_id_seq');
    }
}
