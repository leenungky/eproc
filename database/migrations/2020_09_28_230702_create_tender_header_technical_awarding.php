...
class CreateTenderHeaderTechnicalAwarding extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tender_header_technical_awarding', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tender_header_technical_awarding');
    }
}
