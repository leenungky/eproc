...
class PoTenderItemsText extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('po_item_text', function (Blueprint $table) {
            $table->id();
        ...
        DB::statement('insert into po_item_text
    ...
    {
        Schema::dropIfExists('po_item_text');
    }
}
