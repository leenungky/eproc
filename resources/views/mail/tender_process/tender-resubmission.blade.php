...
<body>
    ...
    <p>{{$tenderStage}} {{$tender->tender_number}} {{$tender->title}} has been resubmitted.</p>
    <p>To participate in the event, please access <a href="{{$linkTender}}">here</a>. After you log on view the Event details.</p>
