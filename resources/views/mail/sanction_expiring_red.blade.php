...
Your sanction type is <b>{{ $vendor->sanction_type }} ({{ $vendor->sanction_type_description }})</b> will expire on {{$vendor->valid_thru_date}}. You are not able to register for all tender process. Please notice your sanction type in eProcurement system.
