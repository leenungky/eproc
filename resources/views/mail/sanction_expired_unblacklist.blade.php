...
Your sanction type is <b>{{ $vendor->sanction_type }} ({{ $vendor->sanction_type_description }})</b> since the Sanction has expired on {{$vendor->valid_thru_date}}. You are able to register for all tender process.
