...
You have been charged a sanction type is <b>{{ $vendor->sanction_type }} ({{ $vendor->sanction_type_description }})</b>. Please notice your sanction type in eProcurement system.
