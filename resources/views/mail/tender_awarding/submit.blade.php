...
<body>
    ...
    <p>{{$tenderStage}} {{$tender->tender_number}} {{$tender->title}} has been evaluated.
        You have been {{$vendor->awarding_status == 'winner' ? 'AWARDED' : 'NOTAWARDED'}} from the Tender evant.</p>
