...
@php 
    ...
    $formLayout = 'vendor.profiles.form.form_shareholder';
@endphp
@section('menuheader')
...
@section('contentbody')
<div class="col-sm-12 mt-lg-2 mb-lg-3" hidden>
    <div class="form-group-sm row ml-5 mr-5">
        <label for="total_share" class="col-form-label lbl-right lbl-field-info">{{ __('homepage.current_total_share') }}&nbsp;:</label>
        <div class="div-sm-info">
            <p class="field-info">xx %</p>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    require(["bootstrap-fileinput-fas"],function(){
        ...
        $("#ktp_attachment").fileinput({'showUpload':false, 'previewFileType':'any','theme':'fas', maxFileSize: maxUploadSize});
    });
    });
</script>
@endsection