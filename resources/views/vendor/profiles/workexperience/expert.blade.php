...
@php
    $formName = 'frmexpert';
    $formLayout = 'vendor.profiles.form.form_expert';
@endphp
...
require(['moment'], function(){
    ...
    require(["bootstrap-fileinput-fas"],function(){
        ...
        $("#attachment").fileinput({'showUpload':false, 'previewFileType':'any','theme':'fas', 'required':true, 'maxFileSize' : maxUploadSize});
        $(".date").datetimepicker({
            format:uiDateFormat,
        });
    });
