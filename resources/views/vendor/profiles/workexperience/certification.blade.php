...
@php
    $formName = 'frmcertification';
    $formLayout = 'vendor.profiles.form.form_certification';
@endphp
...
require(['moment'], function(){
    ...
    require(["bootstrap-fileinput-fas"],function(){
        ...
        $("#attachment").fileinput({'showUpload':false, 'previewFileType':'any','theme':'fas', 'maxFileSize' : maxUploadSize});
        $(".date").datetimepicker({
            useCurrent: false,
            format: uiDateFormat
        });
