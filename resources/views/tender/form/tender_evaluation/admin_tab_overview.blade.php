<div class="tab-body">
    <div class="has-footer has-tab" style="padding: 0;">
        ...
        @elseif($statusProcess == 'finish-4' || $statusProcess == 'finish-3-view')
        <div class="alert alert-info alert-flat no-margin" role="alert">
        ...
        <div class="">
            <table id="dt-vendor-submission" class="table table-sm table-bordered table-striped table-vcenter">
                <thead>
                    <tr>
                        @foreach ($tenderData['process_tender_evaluation']['fields1'] as $field)
    ...
    <div class="app-footer">
        <div class="app-footer__inner">
            ...
            <div class="app-footer-right">
                {{-- @include('tender.form.tender_evaluation.admin_button_technical') --}}
