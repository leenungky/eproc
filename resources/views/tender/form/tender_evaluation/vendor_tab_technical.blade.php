                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-7">
                                    <textarea name="quotation_note" class="form-control form-control-sm" @if(!$enabledTc) disabled @endif
                                        rows="3">{{$technical['header']->quotation_note ?? ''}}</textarea>
                                </div>
                            </div>
                            @if($tender->tkdn_option == 1)
                            <div class="form-group row mb-2">
                                <label for="tkdn_percentage" class="col-5 col-form-label text-right">{{__('tender.process.fields.tkdn_percentage')}}</label>
                                <div class="col-7">
                                    <input name="tkdn_percentage" type="text" min="0" max="100" class="form-control form-control-sm" @if(!$enabledTc) disabled @endif
                                        data-val="{{$technical['header']->tkdn_percentage ?? ''}}"
                ...
                <div class="">
                    <table id="dt-tc-items" class="table table-sm table-bordered table-striped table-vcenter">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th class="description">{{__('purchaserequisition.number')}}</th>
                                <th class="description">{{__('purchaserequisition.line_number')}}</th>
                                <th class="is_required">{{__('purchaserequisition.description')}}</th>
                                <th class="is_required">{{__('purchaserequisition.qty')}}</th>
                                <th class="is_required">{{__('purchaserequisition.uom')}}</th>
                                <th class="is_required">{{__('purchaserequisition.price_unit')}}</th>
