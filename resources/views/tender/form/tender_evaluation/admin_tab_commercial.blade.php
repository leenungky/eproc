    ...
    <div class="has-footer has-tab" style="padding: 0;">
        <div class="card card-submission">
            ...
            <div class="card-body overflow-hidden">
                <div class="">
                    <table id="dt-commercial-vendor" class="table table-sm table-bordered table-striped table-vcenter">
                        <thead>
                            <tr>
                                @foreach ($tenderData['process_tender_evaluation']['fields2'] as $field)
        ...
        <div class="card-submission-detail" style="display: none;">
                        ...
                        <div class="row" style="overflow: hidden;">
                            <div class="col-5">
                                <dl class="row">
                                    ...
                                    <dt class="col-sm-7 text-right">{{__('tender.process.fields.incoterm_location')}} :</dt>
                            ...
                            <div class="col-7">
                                <dl class="row">
                                    ...
                                    <dt class="col-sm-5 text-right">{{__('tender.bid_bond')}} :</dt>
                                    <dd class="col-sm-7 bid_bond_value">-</dd>

                                    <dt class="col-sm-5 text-right">{{__('tender.process.fields.bid_bond_end_date')}} :</dt>
            ...
            <div class="card card-tender-item" style="margin-top: 20px;">
                <div class="card-header">
                    ...
                    <div class="card-header-right" hiden>
                        ...
                        @endif
                        <div class="text-right" style="width: 75px;display:none;">
                ...
                <div class="card-body">
                    <div class="">
                        <table id="dt-commercial-items" class="table table-sm table-bordered table-striped table-vcenter table-wrap">
                            <thead>
                                <tr>
                                    <th>No</th>
            ...
            <div class="card card-tender-document" style="margin-top: 20px;">
                ...
                <div class="card-body overflow-hidden">
                    <div class="">
                        <table id="dt-commercial-document" class="table table-sm table-bordered table-striped table-vcenter dt-bid-doc-requirement" style="width:100%">
                            <thead>
                                <tr>
                                    <th>No</th>
    ...
    <div class="app-footer">
        <div class="app-footer__inner">
            ...
            <div class="app-footer-right button-header">
                @include('tender.form.tender_evaluation.admin_button_commercial')
            </div>
        </div>
    </div>
</div>
