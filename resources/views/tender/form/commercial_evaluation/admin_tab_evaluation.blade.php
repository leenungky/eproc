                ...
                <div class="">
                    <table id="dt-evaluation-vendor" class="table table-sm table-bordered table-striped table-vcenter">
                        <thead>
                            <tr>
                                <tr>
                                    @foreach ($tenderData['process_commercial_evaluation']['fields3'] as $field)
    ...
    <div class="app-footer">
        <div class="app-footer__inner">
            ...
            <div class="app-footer-right">
                <a id="btn_print" target="_blank" href="" class="btn btn-outline-secondary mr-2"><i class="fa fa-file-excel"></i> CBE {{__('common.print')}}</a>
                <button class="btn btn-outline-secondary btn_addinfo">
                    <i class="fa fa-file"></i>&nbsp;&nbsp;&nbsp;{{__('tender.process.btn_add_info')}}</button>
                @if($statusProcess == 'opened-4')
                <button class="btn btn-outline-secondary ml-2 btn_approval">
                    <i class="fa fa-file"></i>&nbsp;&nbsp;&nbsp;{{__('tender.process.btn_approval')}}</button>
                <button class="btn btn-success ml-2 btn_finish" @if(!$canFinish || $tender->commercial_approval_status==\App\Enums\TenderSubmissionEnum::STATUS_ITEM[2]) disabled @endif>
