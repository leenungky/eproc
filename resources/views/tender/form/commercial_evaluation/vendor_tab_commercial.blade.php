<div class="tab-body">
    ...
    <div id="card-schedule" class="card">
        <div class="card-body card-schedule" style="padding: 10px;">
            <button class="btn btn_new_doc btn-success" @if(!in_array($statusProcess,['started-4','started-3'])) disabled @endif>
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-7">
                                    ...
                                    <input name="quotation_number" placeholder="{{__('tender.process.fields.quotation_number')}}" type="text"
                                        @if(!$enabledCom) disabled @endif required="required"
                                        class="form-control form-control-sm" value="{{$commercial['header']->quotation_number ?? ''}}" />
                                </div>
                            </div>
                            <div class="form-group row mb-2">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-7">
                                    <input name="quotation_end_date" type="text" readonly required="required"
                                        class="form-control form-control-sm" value="{{$commercial['quo_validity_date']}}" />
                                </div>
                            </div>
                            <div class="form-group row mb-2">
                                <label for="incoterm" class="col-5 col-form-label text-right">{{__('tender.incoterm')}}</label>
                                <div class="col-7">
                                    <select id="incoterm" name="incoterm" class="custom-select custom-select-sm" @if(!$enabledCom) disabled @endif>
        ...
        <div class="card card-tender-item" style="margin-top: 20px;">
            <div class="card-header">
                ...
                <div class="card-header-right" hiden>
                    ...
                    @endif
                    <div>
                        <select name="currency_code" class="custom-select custom-select-sm"
                    ...
                    @if($enabledCom)
                    <button class="btn btn-save-items btn-success ml-2" type="submit" disabled>
                        <i class="fa fa-save"></i> {{__('tender.save')}}</button>
                    @endif
                </div>
            </div>
