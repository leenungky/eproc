<div id="{{$form_name}}_modal" class="modal fade form_specification_modal" role="dialog" aria-hidden="true" data-focus="false">
        ...
        <div class="modal-content">
            ...
            <form id="{{$form_name}}" name='{{$form_name}}' enctype="multipart/form-data" class="needs-validation" novalidate>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-sm btn-secondary cancel" data-dismiss="modal">{{__('homepage.cancel')}}</button>
                    <button type="submit" class="btn btn-sm btn-primary save">{{__('homepage.save')}}</button>
                </div>
            </form>
        </div>
    </div>
