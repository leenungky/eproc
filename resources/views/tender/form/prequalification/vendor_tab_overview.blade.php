<div class="tab-body">
    <div class="@if($statusProcess == "" && $next != $type) has-footer @endif has-tab" style="padding: 0">
        @if($statusProcess  == 'registration')
        <div class="alert alert-info alert-flat no-margin" role="alert" @if($tender->visibility_bid_document != 1) hidden @endif>
        ...
        <div class="alert alert-info alert-flat no-margin" @if($tender->visibility_bid_document != 1) hidden @endif role="alert">
        ...
        <div id="card-schedule" class="card" style="margin-bottom: 20px;">
            <div class="card-header">
                <div class="card-header-left">
                    <span class="heading-title">{{__('tender.prequalification')}}</span>
                </div>
            </div>
