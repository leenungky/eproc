    ...
    <div class="has-footer has-tab" style="padding: 0">
        <div class="card card-submission">
            <div class="card-body overflow-hidden">
                <div class="">
                    <table id="dt-vendor-awarding" class="table table-sm table-bordered table-striped table-vcenter"
                        style="width:100%">
                        <thead>
                            <tr>
                                @foreach ($tenderData['awarding_process']['fields'] as $field)
        ...
        <div class="card-submission-detail" style="display: none;">
            <div class="card card-tender-header" style="padding-top: 10px;">
                <div class="card-body">
                    <div class="frmTenderHeader col-12 form-view">
                        ...
                        <input name="vendor_code" type="hidden" />
                        <div class="row div-date" style="overflow: hidden;">
                            <div class="col-5">
                                <dl class="row">
            ...
            <div class="card card-tender-item" style="margin-top: 20px;">
                <div class="card-header">
                    ...
                    <div class="card-header-right" hiden>
                        ...
                        @endif
                        <button class="btn btn-save-items-awarding btn-success ml-2" type="button">
                            <i class="fa fa-save"></i> {{__('tender.process.btn_save_awarding')}}</button>
                    </div>
                </div>
                <div class="card-body">
                    <div class="">
