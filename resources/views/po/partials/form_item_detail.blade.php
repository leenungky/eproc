...
<div class="card item-detail" style="margin-bottom: 20px;">
    <div class="card-body" >
                ...
                <div class="row detail-content">
                    <div class="col-sm-4">
                        ...
                        <table class="table table-borderless">
                            @foreach ($tenderData['tender_'.$type]['fields_item'] as $k => $field)
                                @if($k < 12)
                                <tr>
        ...
        @include('po.partials.form_item_detail_text')
        @include('po.partials.form_item_detail_service')
        @include('po.partials.form_item_detail_tax')
        @include('po.partials.form_item_detail_cost')
    </div>
