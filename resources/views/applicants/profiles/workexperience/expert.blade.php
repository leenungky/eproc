...
$vendorTypes = ['Agent','Distributor','Manufacturer','Supplier','Subcontractor'];
$fields = [
    'full_name','date_of_birth','education','major','ktp_number','address','job_experience',
    'year_experience','certification','certification_number','attachment'
];
@endphp
...
<div class="card-header-left">
    <span class="heading-title">{{ __('homepage.competency_and_workexperience') }}: {{ __('homepage.experts') }}</span>
</div>
<div class="card-header-right">
    <div class="button-group">
        ...
        @endif
        <button id="btn_create_new_tax" class="btn btn-sm btn-success" data-toggle="modal" data-target="#frmexpert_modal" data-backdrop="static" data-keyboard="false"><i class="fas fa-plus mr-2" aria-hidden="true"></i>{{ __('homepage.create_new_entry') }}</button>
    </div>
</div>
@endsection
...
$modal1 = [
    ...
    'contents' => '',
    'form_layout' => 'applicants.profiles.form.form_expert',
    'form_name' => 'frmexpert',
];
?>
