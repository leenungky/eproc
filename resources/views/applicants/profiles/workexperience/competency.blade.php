...
<div class="card-header-left">
    <span class="heading-title">{{ __('homepage.competency_and_workexperience') }}: {{ __('homepage.competency') }}</span>
</div>
<div class="card-header-right">
    <div class="button-group">
        ...
        @endif
        <button id="btn_create_new_tax" class="btn btn-sm btn-success" data-toggle="modal" data-target="#frmcompetency_modal" data-backdrop="static" data-keyboard="false"><i class="fas fa-plus mr-2" aria-hidden="true"></i>{{ __('homepage.create_new_entry') }}</button>
    </div>
</div>
@endsection
...
<table class="table table-sm table-striped table-bordered">
    ...
    <tbody>
        @php ($fields = ['classification','sub_classification','competency_detail','vendor_type','attachment'])
        @if( $profiles->count() > 0 )
            <?php $i = 1; ?>
...
$modal1 = [
    ...
    'contents' => '',
    'form_layout' => 'applicants.profiles.form.form_competency',
    'form_name' => 'frmcompetency',
];
?>
