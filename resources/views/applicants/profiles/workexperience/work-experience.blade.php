...
@php 
$fields = [
    'classification','sub_classification','project_name','project_location','contract_owner','country',
    'province','city','sub_district','postal_code','address','contact_person','phone_number','contract_number','valid_from_date',
    'valid_thru_date','currency','contract_value','bast_date','bast_no','bast_attachment','testimony','testimony_attachment'
];
$currencies = ['IDR'=>'Rupiah','USD'=>'Dollar'];
$classifications = ['01'=>'01 - Bahan Baku/Barang Dagangan'];
$subclassifications = ['011'=>'011 - Phospate Rock'];
$countries = ['ID'=>'Indonesia','SG'=>'Singapore'];
$provinces = ['1'=>'DKI Jakarta','2'=>'Jawa Barat'];
$cities = ['1'=>'Jakarta','2'=>'Bandung'];
$subdistricts = ['1'=>'Jakarta Utara','2'=>'Jakarta Selatan'];
@endphp
...
<div class="card-header-left">
    <span class="heading-title">{{ __('homepage.competency_and_workexperience') }}: {{ __('homepage.experience') }}</span>
</div>
<div class="card-header-right">
    <div class="button-group">
        ...
        @endif
        <button id="btn_create_new_tax" class="btn btn-sm btn-success" data-toggle="modal" data-target="#frmexperience_modal" data-backdrop="static" data-keyboard="false"><i class="fas fa-plus mr-2" aria-hidden="true"></i>{{ __('homepage.create_new_entry') }}</button>
    </div>
</div>
@endsection
...
$modal1 = [
    ...
    'contents' => '',
    'form_layout' => 'applicants.profiles.form.form_experience',
    'form_name' => 'frmexperience',
];
?>
