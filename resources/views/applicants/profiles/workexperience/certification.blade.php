...
@php
$certifications = [
    'ISO','OHSAS','ASME','API','TKDN','Others'
];
@endphp
...
<div class="card-header-left">
    <span class="heading-title">{{ __('homepage.competency_and_workexperience') }}: {{ __('homepage.certification') }}</span>
</div>
<div class="card-header-right">
    <div class="button-group">
        ...
        @endif
        <button id="btn_create_new_tax" class="btn btn-sm btn-success" data-toggle="modal" data-target="#frmcertification_modal" data-backdrop="static" data-keyboard="false"><i class="fas fa-plus mr-2" aria-hidden="true"></i>{{ __('homepage.create_new_entry') }}</button>
    </div>
</div>
@endsection
...
<table class="table table-sm table-striped table-bordered">
    ...
    <tbody>
        @php ($fields = ['certification_type','description','valid_from_date','valid_thru_date','attachment'])
        @if( $profiles->count() > 0 )
            <?php $i = 1; ?>
...
$modal1 = [
    ...
    'contents' => '',
    'form_layout' => 'applicants.profiles.form.form_certification',
    'form_name' => 'frmcertification',
];
?>
