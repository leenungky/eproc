...
@php
$equipmentTypes = ['01'=>'01 - Bahan Baku/Barang Dagangan'];
$fields = [
    'equipment_type','total','measurement','brand','condition','location','manufacturing_date','ownership'
];
@endphp
...
<div class="card-header-right">
    <div class="button-group">
        ...
        @endif
        <button id="btn_create_new_tax" class="btn btn-sm btn-success" data-toggle="modal" data-target="#frmtool_modal" data-backdrop="static" data-keyboard="false"><i class="fas fa-plus mr-2" aria-hidden="true"></i>{{ __('homepage.create_new_entry') }}</button>
    </div>
</div>
@endsection
...
$modal1 = [
    ...
    'contents' => '',
    'form_layout' => 'applicants.profiles.form.form_tool',
    'form_name' => 'frmtool',
];
?>
