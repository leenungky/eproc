        ...
        var d = "datetimepicker"
          ...
          , t = {
            ...
            keyBinds: {
                ...
                t: function() {
                    return this.date(this.getMoment()),
                    !0
                },
                delete: function() {
          ...
          , u = function() {
            ...
            i.prototype._showMode = function(a) {
                this.widget && (a && (this.currentViewMode = Math.max(s, Math.min(3, this.currentViewMode + a))),
                this.widget.find(".datepicker > div").hide().filter(".datepicker-" + n[this.currentViewMode].CLASS_NAME).show())
            }
            ,
            ...
            i.prototype._keydown = function(a) {
                ...
                q[i] = j;
                for (c in q)
                    q.hasOwnProperty(c) && q[c] === j && (g.push(c),
                ...
                b && b.call(this.widget) && (a.stopPropagation(),
                a.preventDefault())
            }
            ,
            i.prototype._keyup = function(a) {
                q[a.which] = "r",
                r[a.which] && (r[a.which] = !1,
                a.stopPropagation(),
                a.preventDefault())
            }
            ,
            ...
            i.prototype.getMoment = function(a) {
                var c = void 0;
                return c = void 0 === a || null === a ? b() : this._hasTimeZone() ? b.tz(a, this.parseFormats, this._options.useStrict, this._options.timeZone) : b(a, this.parseFormats, this._options.useStrict),
            ...
            i.prototype.viewMode = function(a) {
                ...
                if (i.ViewModes.indexOf(a) === -1)
                    throw new TypeError("viewMode() parameter must be one of (" + i.ViewModes.join(", ") + ") value");
                this._options.viewMode = a,
                this.currentViewMode = Math.max(i.ViewModes.indexOf(a) - 1, i.MinViewModeNumber),
                this._showMode()
            }
            ,
        ...
        var g = e.fn[f.NAME]
          ...
          , l = function(g) {
            ...
            k.prototype._getToolbar = function() {
                ...
                !this._options.sideBySide && this._hasDate() && this._hasTime() && a.push(e("<td>").append(e("<a>").attr({
                    "data-action": "togglePicker",
                    title: this._options.tooltips.selectTime
                }).append(e("<span>").addClass(this._options.icons.time)))),
                this._options.buttons.showClear && a.push(e("<td>").append(e("<a>").attr({
                    "data-action": "clear",
            ...
            k.prototype._getTemplate = function() {
                ...
                this._hasDate() && d.append(e("<li>").addClass(this._options.collapse && this._hasTime() ? "collapse" : "").addClass(this._options.collapse && this._hasTime() && "time" === this._options.viewMode ? "" : "show").append(b)),
                "default" === this._options.toolbarPlacement && d.append(f),
                this._hasTime() && d.append(e("<li>").addClass(this._options.collapse && this._hasDate() ? "collapse" : "").addClass(this._options.collapse && this._hasDate() && "time" === this._options.viewMode ? "show" : "").append(c)),
            ...
            k.prototype._updateYears = function() {
                ...
                f += '<span data-action="selectYear" class="year old">' + (d.year() - 1) + "</span>"; !d.isAfter(e, "y"); )
            ...
            k.prototype._doAction = function(a, b) {
                ...
                case "selectMonth":
                    ...
                    this.currentViewMode === f.MinViewModeNumber ? (this._setValue(c.clone().year(this._viewDate.year()).month(this._viewDate.month()), this._getLastPickedDateIndex()),
                ...
                case "selectYear":
                    ...
                    this.currentViewMode === f.MinViewModeNumber ? (this._setValue(c.clone().year(this._viewDate.year()), this._getLastPickedDateIndex()),
                    this._options.inline || this.hide()) : (this._showMode(-1),
                    this._fillDate()),
                ...
                case "togglePicker":
                    var r = e(a.target)
                      ...
                      , x = void 0;
                    if (u && u.length) {
                        if (x = u.data("collapse"),
                        x && x.transitioning)
                            return !0;
                        u.collapse ? (u.collapse("hide"),
                        v.collapse("show")) : (u.removeClass("show"),
                        v.addClass("show")),
