                ...
                case 'portType':
                    switch ($name) {
                        ...
                        default:
                            ...
                            if(isset($this->currentPortOperation)) $this->portTypes[$this->currentPortType][$this->currentPortOperation][$name]['message'] = $m;
                            break;
                    }
                    break;
                case 'binding':
    ...
    function call($operation, $params = array(), $namespace = 'http://tempuri.org', $soapAction = '', $headers = false, $rpcParams = null, $style = 'rpc', $use = 'encoded')
    {
        ...
        if ($errstr = $this->getError()) {
            ...
            if (is_array($return) && isset($return['faultcode'])) {
                ...
                $this->setError((is_array($return['faultcode'])?implode(', ', $return['faultcode']):$return['faultcode']) . ': ' . is_array($return['faultstring'])?implode("::",$return['faultstring']):$return['faultstring']);
                $this->fault = true;
